...
const props = defineProps(['total_products', 'customers'])

const total_products = computed(() => usePage().props.value.total_products)
const customers = computed(() => usePage().props.value.customers)
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                            <div class="flex-grow-1">
                                                <h4 class="fs-16 mb-1">Welcome, {{ $page.props.auth.user.account.name }}!</h4>
                                            ...
                                            <div class="mt-3 mt-lg-0">
                                                <form action="javascript:void(0);">
                                                    <div class="row g-3 mb-0 align-items-center">
                                                        <!--end col-->
                                                        <div class="col-auto">
                                                            <Link :href="route('product.create')" class="btn btn-primary"><i class="ri-add-circle-line align-middle me-1"></i> Add Product</Link>
                                                        </div>
                                                    </div>
                                                    <!--end row-->
                                                </form>
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">{{ customers }}</h4>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="card">
                                            ...
                                            <h5 class="mt-4">Sorry! No Recent Orders Found</h5>
                                        </div>
                                            </div>
                                        </div> <!-- .card-->
                                    </div> <!-- .col-->
